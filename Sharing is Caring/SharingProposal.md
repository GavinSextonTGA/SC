...
### Synth 1: Bass!
The celeste bass (from the track ressurections specifically) is a monophonic saw wave with that slides between pitches and has a lot of distortion, pink noise and bitcrushed,with an Sin LFO controlling its low pass filter, and some reverb, all of which I THINK can be done within supercollider.
### Synth 2: The LEAD
